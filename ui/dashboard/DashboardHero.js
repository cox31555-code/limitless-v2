      ...
      <div className={styles.heroContent}>
        ...
        {badge && (
          <div className={styles.badgeArea}>
            <span className={styles.allianzBadge}>
              {badge}
            </span>
          </div>
        )}
