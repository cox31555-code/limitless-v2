    ...
    <div className={styles.container}>
      <div className={styles.headerWrapper}>
        ...
        <p className={`${styles.subtitle} ${poppins.className}`}>
          Find the perfect insurance cover for your vehicle, driving style, and budget
        </p>
      </div>

      <div className={styles.grid}>
        {insuranceData.map((insurance, index) => (
          <div key={index} className={`${styles.card} ${insurance.badge ? styles.featured : ""}`}>
            {insurance.badge && <div className={styles.badge}>{insurance.badge}</div>}
            ...
            <div className={styles.content}>
              ...
              <button className={`${styles.ctaButton} ${poppins.className}`}>
                Get a quote
