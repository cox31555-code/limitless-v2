            ...
            {covered.features.map((feature, index) => (
              <React.Fragment key={index}>
                <div className={styles.item}>
                  ...
                  <p className={`${styles.itemText} ${poppins.className}`}>{feature}</p>
                </div>
                {index < covered.features.length - 1 && (
                  <svg className={styles.separator} width="581" height="1" viewBox="0 0 581 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.421875 0.423584L580.422 0.423533" stroke="#000822" strokeOpacity="0.24" strokeWidth="0.847081" strokeLinecap="round"/>
                  </svg>
                )}
              </React.Fragment>
            ))}
          ...
          <div className={styles.itemsList}>
            {unCovered.features.map((feature, index) => (
              <React.Fragment key={index}>
                ...
                {index < unCovered.features.length - 1 && (
                  <svg className={styles.separator} width="581" height="1" viewBox="0 0 581 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0.421875 0.423584L580.422 0.423533" stroke="#000822" strokeOpacity="0.24" strokeWidth="0.847081" strokeLinecap="round"/>
                  </svg>
                )}
