  ...
  return (
    <div className={styles.pageWrapper}>
      ...
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.greetingArea}>
            <h1 className={`${styles.greetingTitle} ${plusJakartaSans?.className || ""}`}>Your Insurance Quote</h1>
            <p className={styles.greetingSubtitle}>Review your cover details and complete your purchase</p>
          </div>
        </div>
      </section>
      ...
      <div className={styles.breadcrumb}>
        ...
        <span className={styles.breadcrumbItem}>Get Quote</span>
        <span className={styles.breadcrumbSeparator}>›</span>
        <span className={`${styles.breadcrumbItem} ${styles.active}`}>Payment Summary</span>
      </div>
