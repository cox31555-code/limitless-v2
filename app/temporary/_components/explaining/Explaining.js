...
const Explaining = () => {
  return (
    <div className={styles.wrapper}>
      {/* Combined Section - What is and How does temporary vehicle insurance */}
      <div className={styles.container}>
        ...
        <div className={styles.mainContent}>
          {/* Left Side - What is temporary vehicle insurance */}
          <div className={styles.whatIsSection}>
            <div className={styles.content}>
              ...
              <svg className={styles.illustration} width="1202" height="467" viewBox="0 0 1202 467" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="265.512" y="0" width="273.487" height="466.442" fill="url(#paint0_linear_1640_5327)" fillOpacity="0.48"/>
          ...
          {/* Right Side - How does temporary vehicle insurance work */}
          <div className={styles.howIsSection}>
