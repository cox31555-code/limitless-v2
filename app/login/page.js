  ...
  return (
    <div className={styles.page}>
      <div className={styles.leftSection}>
        ...
        <svg className={styles.logo} width="228" height="234" viewBox="0 0 228 234" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: "block" }}>
          <rect width="228" height="234" rx="21.1893" fill="rgb(3, 136, 255)" style={{ display: "inline", fill: "rgb(3, 136, 255)" }}/>
