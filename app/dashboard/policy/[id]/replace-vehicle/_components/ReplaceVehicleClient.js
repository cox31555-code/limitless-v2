        ...
        <section className={layoutStyles.heroSection}>
          ...
          <div className={layoutStyles.heroContent}>
            <div className={layoutStyles.greetingArea}>
              <h1 className={`${layoutStyles.greetingTitle} ${plusJakartaSans.className}`}>Replace Your Vehicle</h1>
              <p className={layoutStyles.greetingSubtitle}>Select a new vehicle for your policy</p>
            </div>
          </div>
        </section>
