      ...
      <section className={layoutStyles.heroSection}>
        ...
        <div className={layoutStyles.heroContent}>
          <div className={layoutStyles.greetingArea}>
            <h1 className={`${layoutStyles.greetingTitle} ${plusJakartaSans.className}`}>Edit Vehicle Details</h1>
            <p className={layoutStyles.greetingSubtitle}>Update your vehicle information</p>
          </div>
        </div>
      </section>
