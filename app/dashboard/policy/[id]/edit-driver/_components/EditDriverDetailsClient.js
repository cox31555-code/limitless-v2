      ...
      <section className={layoutStyles.heroSection}>
        ...
        <div className={layoutStyles.heroContent}>
          <div className={layoutStyles.greetingArea}>
            <h1 className={`${layoutStyles.greetingTitle} ${plusJakartaSans.className}`}>Edit driver details</h1>
            <p className={layoutStyles.greetingSubtitle}>Update {driver?.firstName} {driver?.surname}'s information</p>
          </div>
        </div>
      </section>
