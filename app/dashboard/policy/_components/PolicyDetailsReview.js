  ...
  return (
    <div className={styles.container}>
      ...
      <section className={styles.expandableCard} aria-labelledby="policy-details-heading">
        ...
        >
          <div className={styles.headerContent}>
            ...
            <h3 id="policy-details-heading" className={styles.sectionTitle}>
              Your Cover Details
            </h3>
          </div>
          <svg
        ...
        {expandedSections.policyDetails && (
          <div id="policy-details-content" className={styles.cardContent} role="region" aria-labelledby="policy-details-heading">
            ...
            <div className={styles.detailsGrid}>
              ...
              <div className={styles.detailItem}>
                <span className={styles.detailLabel}>Non-recommended repairer excess</span>
                <span className={styles.detailValue}>£400</span>
              </div>
            </div>
            <p className={styles.disclaimer}>
              Your total excess applies every time you claim and to every car you're claiming on. Non-recommended repairer excess is in addition to main excess and applies to glass replacement but not repair.
            </p>
      ...
      <section className={styles.expandableCard} aria-labelledby="car-details-heading">
        ...
        >
          <div className={styles.headerContent}>
            ...
            <h3 id="car-details-heading" className={styles.sectionTitle}>
              Vehicle Information
            </h3>
          </div>
          <svg
        ...
        {expandedSections.carDetails && (
          <div id="car-details-content" className={styles.cardContent} role="region" aria-labelledby="car-details-heading">
            ...
            <div className={styles.vehicleSubsection}>
              <h4 className={styles.subsectionTitle}>Your car</h4>
              <div className={styles.detailsGrid}>
                <div className={styles.detailItem}>
            ...
            {/* Car value section */}
            <div className={styles.vehicleSubsection}>
              <h4 className={styles.subsectionTitle}>Car value</h4>
              <div className={styles.detailsGrid}>
                <div className={styles.detailItem}>
            ...
            {/* Car usage section */}
            <div className={styles.vehicleSubsection}>
              <h4 className={styles.subsectionTitle}>Car usage</h4>
              <div className={styles.detailsGrid}>
                <div className={styles.detailItem}>
            ...
            {/* Car storage section */}
            <div className={styles.vehicleSubsection}>
              <h4 className={styles.subsectionTitle}>Car storage</h4>
              <div className={styles.detailsGrid}>
                <div className={styles.detailItem}>
            ...
            {/* Other cars section */}
            <div className={styles.vehicleSubsection}>
              <h4 className={styles.subsectionTitle}>Other cars</h4>
              <div className={styles.detailsGrid}>
                <div className={styles.detailItem}>
      ...
      <section className={styles.expandableCard} aria-labelledby="drivers-heading">
        ...
        >
          <div className={styles.headerContent}>
            ...
            <h3 id="drivers-heading" className={styles.sectionTitle}>
              Named Drivers
            </h3>
          </div>
          <svg
      ...
      <section className={styles.expandableCard} aria-labelledby="driver-details-heading">
        ...
        >
          <div className={styles.headerContent}>
            ...
            <h3 id="driver-details-heading" className={styles.sectionTitle}>
              Driver Information
            </h3>
          </div>
          <svg
      ...
      <section className={styles.expandableCard} aria-labelledby="documents-heading">
        ...
        >
          <div className={styles.headerContent}>
            ...
            <h3 id="documents-heading" className={styles.sectionTitle}>
              Download Documents
            </h3>
          </div>
          <svg
      ...
      <section className={styles.paymentBreakdownCard} aria-labelledby="payment-breakdown-heading">
        <h3 id="payment-breakdown-heading" className={styles.breakdownTitle}>
          Payment Schedule
        </h3>
      ...
      {/* No Claims Discount Upload Section */}
      <NoClaimsUpload />
