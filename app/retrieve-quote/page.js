      ...
      <section className={styles.heroSection}>
        ...
        <div className={styles.heroContent}>
          <div className={styles.greetingArea}>
            <h1 className={styles.greetingTitle}>Retrieve Your Quote</h1>
            <p className={styles.greetingSubtitle}>Enter your email address to access your saved quote and continue where you left off.</p>
          </div>
        </div>
      </section>
