...
const AnnualInsuranceContent = () => {
  ...
  const [coverSubStep, setCoverSubStep] = useState("details"); // "details", "additionalDrivers", "addDriver", "addDriverClaimsAndConvictions", "addDriverClaim", "addDriverConviction", or "carOwner"
