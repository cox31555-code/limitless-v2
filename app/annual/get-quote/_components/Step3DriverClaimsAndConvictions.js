...
const Step3DriverClaimsAndConvictions = ({ driverData, onBack, onAddDriver, onAddClaim, onAddConviction, claims = [], convictions = [] }) => {
  ...
  return (
    <StepContainer title="Additional drivers - Claims and convictions">
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Have they had any motor accidents, claims or losses in the past 5 years, no matter who was at fault or if a claim was made?</h3>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Have they had any driving related convictions, endorsements, penalties, disqualifications or bans in the past 5 years?</h3>
        </div>
