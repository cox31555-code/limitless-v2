...
const QuoteHeader = ({ title = "Annual Car Insurance", userName = null }) => {
  return (
    <section className={styles.heroSection} suppressHydrationWarning>
      <div className={styles.heroBackground} suppressHydrationWarning>
      ...
      <div className={styles.heroContent}>
        <div className={styles.greetingArea}>
          <h1 className={styles.greetingTitle}>{userName ? `Hi, ${userName}` : title}</h1>
          <p className={styles.greetingSubtitle}>
            {userName ? "Welcome back. Manage and review your insurance policies anytime, anywhere" : "Get comprehensive cover in just a few simple steps"}
          </p>
        </div>
