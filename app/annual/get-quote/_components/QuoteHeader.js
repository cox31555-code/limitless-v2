      ...
      <div className={styles.heroContent}>
        <div className={styles.greetingArea}>
          ...
          <p className={styles.greetingSubtitle}>
            Get comprehensive cover in just a few simple steps
          </p>
        </div>
      </div>
    </section>
