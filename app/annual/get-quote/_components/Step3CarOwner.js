...
const Step3CarOwner = ({
  ...
  return (
    <StepContainer title="Your policy - Car owner">
      {insuranceType === "Annual" && (
        <div className={sharedStyles.stepSection}>
          <div className={sharedStyles.questionHeader}>
            <h3 className={sharedStyles.mainQuestion}>Who's the main driver of this vehicle?</h3>
          </div>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Are you (or will you be) the registered keeper and legal owner?</h3>
          <p className={sharedStyles.subText}>The registered keeper is named on the V5 certificate (you/they should have a copy).</p>
        </div>
        ...
        <ExpandableQuestion
          question="How can I find out who this is?"
          answer="The registered keeper's details are shown on the V5 registration certificate. This document is held by the registered keeper of the vehicle. If you're unsure, check your V5 certificate or contact your local DVLA office."
        />
      </div>
      ...
      {formData.isRegisteredKeeperAndOwner === "No" && (
        <div className={sharedStyles.stepSection}>
          <div className={sharedStyles.questionHeader}>
            <h3 className={sharedStyles.mainQuestion}>Who's the registered keeper?</h3>
          </div>
          <div className={styles.fieldWrapper}>
            <Dropdown
              label=""
      ...
      {formData.isRegisteredKeeperAndOwner === "No" && (
        <div className={sharedStyles.stepSection}>
          <div className={sharedStyles.questionHeader}>
            <h3 className={sharedStyles.mainQuestion}>Who's the legal owner?</h3>
          </div>
          <div className={styles.fieldWrapper}>
            <Dropdown
              label=""
