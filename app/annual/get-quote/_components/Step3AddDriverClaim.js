            ...
            <>
              ...
              <div className={styles.conditionalSection}>
                ...
                {expandedAtFault && (
                  <div className={styles.expandableContent}>
                    They're considered 'at fault' if they were held liable for this claim. If the claim is unsettled, please declare that they were at fault.
                  </div>
                )}
              ...
              <div className={styles.conditionalSection}>
                ...
                >
                  ...
                  What if nobody was in the vehicle?
                </button>
                {expandedNobodyInCar && (
                  <div className={styles.expandableContent}>
                    If the vehicle was unoccupied, then it's the person who was responsible for it at this point.
                  </div>
                )}
