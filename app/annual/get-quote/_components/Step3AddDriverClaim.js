...
import styles from "./step3AddDriverClaim.module.css";
            ...
            {["Accident", "Theft", "Other"].map((type) => (
              <label key={type} className={styles.radioOption}>
                ...
                <div className={styles.radioContent}>
                  ...
                  {type === "Accident" && (
                    <span className={styles.radioDescription}>This can include incidents where the driver wasn't in the vehicle at the time</span>
                  )}
                  {type === "Theft" && (
                    <span className={styles.radioDescription}>Theft or attempted theft of items within the vehicle or of the actual vehicle itself</span>
                  )}
                  {type === "Other" && (
            ...
            <>
              ...
              <div className={styles.conditionalSection}>
                ...
                <ExpandableQuestion
                  ...
                  answer="They're considered 'at fault' if they were held liable for this claim. If the claim is unsettled, please declare that they were at fault."
                />
              ...
              <div className={styles.conditionalSection}>
                ...
                />
                <ExpandableQuestion
                  question="What if nobody was in the vehicle?"
                  answer="If the vehicle was unoccupied, then it's the person who was responsible for it at this point."
                />
...
export default Step3AddDriverClaim;
