...
const Step2Licence = ({ form }) => {
  ...
  return (
    <StepContainer title="Your details - Your licence">
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>What type of driving licence do you have?</h3>
          <p className={sharedStyles.subText}>Choose the type of licence you'll have at the time this policy starts.</p>
        </div>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Where was your driving licence issued?</h3>
        </div>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>How long have you held this licence?</h3>
      ...
      {shouldShowLicenseNumberSection && (
        <div className={sharedStyles.stepSection}>
          <h3 className={sharedStyles.mainQuestion}>Do you want to share your driving licence number?</h3>
          <p className={sharedStyles.subText}>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Have you passed any additional driving qualifications?</h3>
          <p className={sharedStyles.subText}>
