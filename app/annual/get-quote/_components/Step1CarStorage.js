...
const Step1CarStorage = ({ form }) => {
  ...
  return (
    <StepContainer title="Car details - Car storage">
      {/* Day Storage Section */}
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Where do you keep your car during the day?</h3>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Where do you keep your car during the night?</h3>
          <p className={sharedStyles.subText}>
            If you leave your car in different places throughout the week, just tell us where the car's kept most of the time.
          </p>
        </div>
