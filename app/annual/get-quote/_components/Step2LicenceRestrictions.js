...
const Step2LicenceRestrictions = ({ form }) => {
  ...
  return (
    <StepContainer title="Your details - Licence restrictions">
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Do you have any medical conditions or disabilities that the DVA need to know about?</h3>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Has an insurance provider ever declined, cancelled, or voided your policy or imposed special terms?</h3>
        </div>
      ...
      <div className={sharedStyles.stepSection}>
        <h3 className={sharedStyles.mainQuestion}>Have you got any unspent non-motoring-related criminal convictions?</h3>
        ...
        {expandedCriminal && (
          <div className={styles.expandableContent}>
            An unspent conviction is one that hasn't yet been "spent" according to the Rehabilitation of Offenders Act 1974. The length of time depends on the sentence, but unspent convictions must be disclosed when applying for insurance.
          </div>
        )}
        ...
        {expandedWhatSpent && (
          <div className={styles.expandableContent}>
            Insurance providers need to assess risk factors. Your criminal history helps them determine appropriate premiums and coverage. Providing accurate information is essential for obtaining valid insurance coverage.
          </div>
        )}
      </div>
    </StepContainer>
