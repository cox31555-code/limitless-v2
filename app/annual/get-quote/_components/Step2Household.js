...
const Step2Household = ({ form }) => {
  ...
  return (
    <StepContainer title="Your details - Your household">
      {/* Address Section */}
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>What's your address?</h3>
        </div>
      ...
      <div className={sharedStyles.stepSection}>
        <h3 className={sharedStyles.mainQuestion}>Do you own your home?</h3>
      ...
      {/* Children Section */}
      <div className={sharedStyles.stepSection}>
        <h3 className={sharedStyles.mainQuestion}>Do any children under the age of 16 live with you?</h3>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>Have you continuously lived in the UK since birth?</h3>
