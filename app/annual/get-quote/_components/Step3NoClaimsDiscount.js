...
const Step3NoClaimsDiscount = ({
  ...
  return (
    <StepContainer title="Your policy - Your no claims discount">
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>How many years of no claims discount (NCD) do you have?</h3>
      ...
      {formData.noClaimsDiscount === "No NCD" && (
        <div className={sharedStyles.stepSection}>
          <div className={sharedStyles.questionHeader}>
            <h3 className={sharedStyles.mainQuestion}>Do you have any named driver experience?</h3>
            <p className={sharedStyles.subText}>
          ...
          {[
            ...
            <div className={sharedStyles.stepSection} style={{ marginTop: '2rem', paddingBottom: '0', borderTop: 'none' }}>
              <div className={sharedStyles.questionHeader}>
                <h3 className={sharedStyles.mainQuestion}>How many years of named driver experience have you held, claim-free, that you're able to give proof of?</h3>
              </div>
              <div className={styles.fieldWrapper}>
                <Dropdown
                  label=""
      ...
      {formData.noClaimsDiscount && formData.noClaimsDiscount !== "No NCD" && (
        <div className={sharedStyles.stepSection}>
          <div className={sharedStyles.questionHeader}>
            <h3 className={sharedStyles.mainQuestion}>How did you earn your no claims discount?</h3>
            <p className={sharedStyles.subText}>
