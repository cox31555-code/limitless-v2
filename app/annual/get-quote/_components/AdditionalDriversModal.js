              ...
              <div key={index} className={modalStyles.driverItem}>
                ...
                <div className={modalStyles.driverFormContent}>
                  ...
                  <div className={modalStyles.formSection}>
                    <button type="button" className={`${modalStyles.tileHeader} ${isTileExpanded(index, 'about') ? modalStyles.expanded : ''}`} onClick={() => toggleTile(index, 'about')}>
                  ...
                  {/* Employment Section */}
                  <div className={modalStyles.formSection}>
                    <button type="button" className={`${modalStyles.tileHeader} ${isTileExpanded(index, 'employment') ? modalStyles.expanded : ''}`} onClick={() => toggleTile(index, 'employment')}>
                  ...
                  <div className={modalStyles.formSection}>
                    <button type="button" className={`${modalStyles.tileHeader} ${isTileExpanded(index, 'usage') ? modalStyles.expanded : ''}`} onClick={() => toggleTile(index, 'usage')}>
                  ...
                  <div className={modalStyles.formSection}>
                    <button type="button" className={`${modalStyles.tileHeader} ${isTileExpanded(index, 'driving') ? modalStyles.expanded : ''}`} onClick={() => toggleTile(index, 'driving')}>
