...
const Step2Employment = ({ form }) => {
  ...
  return (
    <StepContainer title="Your details - Your employment">
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>What's your employment status?</h3>
        </div>
      ...
      {isEmployedOrSelfEmployed && (
        <>
          <div className={sharedStyles.stepSection}>
            <div className={sharedStyles.questionHeader}>
              <h3 className={sharedStyles.mainQuestion}>What do you do for a living?</h3>
      ...
      {isStudent && (
        <div className={sharedStyles.stepSection}>
          <h3 className={sharedStyles.mainQuestion}>What type of student are you?</h3>
