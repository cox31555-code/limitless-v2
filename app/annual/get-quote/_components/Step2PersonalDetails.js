...
const Step2PersonalDetails = ({ form }) => {
  ...
  return (
    <StepContainer title="Your details - About you">
      {/* Name Section */}
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>What's your name?</h3>
      ...
      <div className={sharedStyles.stepSection}>
        <div className={sharedStyles.questionHeader}>
          <h3 className={sharedStyles.mainQuestion}>What's your date of birth?</h3>
        </div>
      ...
      <div className={sharedStyles.stepSection}>
        <h3 className={sharedStyles.mainQuestion}>What's your relationship status?</h3>
