...
import styles from "./contactNumbersHero.module.css";

const ContactNumbersHero = () => {
  return (
    <section className={styles.heroSection} suppressHydrationWarning>
      ...
      <div className={styles.heroContent}>
        <div className={styles.mainInfo}>
          <h1 className={styles.title}>Opening Hours & Contact Numbers</h1>
          <p className={styles.subtitle}>
            Get all the information you need about how to reach us
          </p>
        </div>
      </div>
    </section>
...
export default ContactNumbersHero;
